<template>
  <div class="loginContainer">
    ...
    <p class="login_tips">温馨提示：必须使用华夏星元素登记的姓名和手机号</p>
...
import userInfoData from "../../../user.json";
export default {
  data() {
    return {
  ...
  methods: {
    ...
    async mobileLogin() {
      if (this.loginWay) {
        ...
        //用户名登录
        this.userInfo = userInfoData.userArr.filter((i) => {
          return i.name == this.userName && i.phone == this.phone;
        });
      }
