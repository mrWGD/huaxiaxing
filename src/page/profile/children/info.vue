<template>
  <div class="rating_page">
    ...
    <section class="profile-info">
      ...
      <section class="bind-phone">绑定手机</section>
      ...
      >
        ...
        <div class="sa-botton">
          ...
          <div style="display: inline-block">
            <button class="quitlogin" @click="outLogin">退出</button>
          </div>
        </div>
      </section>
    </section>
...
export default {
  ...
  mounted() {
    ...
    this.infotel = this.userInfo.phone;
  },
  methods: {
